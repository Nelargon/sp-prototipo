...
date: "2026-07-27"
minutes: 4
description: "Personal de salud de todo Paraguay se capacita en cuidados esenciales del recién nacido. Qué revisa ese primer control y qué preguntar vos como familia."
intro: "Volvés de la maternidad con el bebé en brazos y una lista de dudas que nadie terminó de explicarte: qué revisan en ese primer control, cuándo hay que volver y qué es realmente urgente. Vale la pena saber qué hay detrás de esas primeras semanas."
tags: ["salud preventiva", "paraguay", "embarazo y bebés", "chequeos"]
sources:
  - "https://www.paho.org/es/noticias/22-7-2026-paraguay-fortalece-competencias-personal-salud-para-mejorar-atencion-neonatal"
status: "publicado"
...
## Un programa nacional detrás de cada control
...
Cada maternidad y cada pediatra tienen su propia rutina, pero un control
esencial de recién nacido apunta, en general, a lo mismo:

- **Peso y evolución**: si el bebé recuperó el peso de nacimiento y sigue
  la curva esperada.
- **Alimentación**: cómo va la lactancia (o la fórmula, si es el caso) y si
  hay señales de que el bebé se alimenta bien.
- **Signos vitales básicos**: temperatura, color de piel, respiración.
- **Reflejos y postura**: que respondan como se espera para esa edad.

Ninguno de estos puntos reemplaza lo que tu pediatra vea en persona. Esta
nota explica el panorama general; ante cualquier duda concreta sobre tu
bebé, la respuesta es siempre consultar a tu pediatra.
...
Llegar con estas preguntas ya armadas ayuda a aprovechar mejor esos
primeros minutos con el pediatra:
...
buen control espera de vos.

Los primeros controles del bebé no son un formulario para completar y
olvidar. Son la etapa donde más se puede prevenir con menos esfuerzo, y
donde tu pediatra es siempre la referencia real, no esta nota ni ninguna
otra.
