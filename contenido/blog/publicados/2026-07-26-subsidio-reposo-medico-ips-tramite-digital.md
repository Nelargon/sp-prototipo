...
date: "2026-07-26"
minutes: 4
description: "Si un médico privado te dio reposo y aportás al IPS, el subsidio se cobra igual. Esta semana quedó habilitado el trámite 100 % digital: así se pide."
intro: "Aportás al IPS por tu trabajo, pero ese día terminaste en un consultorio privado. El médico te da unos días de reposo. Ahí aparece la duda: ¿eso también se cobra, si no te atendiste en la red pública?"
tags: ["ips", "tramites", "paraguay", "sistema-publico"]
sources:
  - "https://www.hoy.com.py/nacionales/2026/07/23/desde-hoy-rige-nuevo-sistema-digital-del-ips-para-tramitar-subsidios-por-reposos-externos"
  - "https://www.abc.com.py/nacionales/2026/07/17/ips-renueva-su-plataforma-tramitar-reposos-medicos-ahora-es-mas-facil/"
status: "publicado"
...
celular, a cualquier hora, sin pedir permiso en el trabajo para ir a hacer
una fila.

## Lo que quedó habilitado esta semana

Desde el 23 de julio rige sin excepciones la nueva plataforma del IPS para
tramitar subsidios por reposos emitidos fuera de la red pública, en
portal.ips.gov.py. El sistema se había lanzado el 16 de julio y esta semana
terminó de habilitarse para todos los casos
...
- Entrás a portal.ips.gov.py con tu usuario de aportante.
- Cargás el certificado de reposo que te dio tu médico, sea del IPS o no.
- El sistema te da un número de expediente al instante.
- Seguís el estado del trámite desde ahí mismo, sin ir a una oficina.

No hace falta guardar el certificado en un cajón esperando el momento de
presentarlo en persona: cargarlo en el portal es el trámite completo.

## Dos dudas comunes

**¿Hace falta ser jubilado del IPS para pedirlo?** No. El subsidio por
reposo es para cualquier aportante activo, no solo para quien ya está
jubilado.

**¿Qué pasa si el reposo lo dio un médico que no conocés en el sistema del
IPS?** No importa: el certificado vale igual, y ahora se carga en la misma
plataforma que los reposos emitidos dentro de la red pública.
