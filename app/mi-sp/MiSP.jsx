        ...
        <div style={css('max-width:860px;margin:0 auto')}>
          ...
          <div className="misp-grid" style={css('display:grid;grid-template-columns:1.4fr 1fr;gap:16px;margin-bottom:40px')}>
            ...
            <div style={css('display:flex;flex-direction:column;gap:16px')}>
              <a href={waHref} onClick={() => go('whatsapp')} target="_blank" rel="noopener" className="sq tarjeta-toque" style={css('flex:1;display:flex;align-items:center;gap:13px;background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.16);--sq:18px;padding:18px 20px;color:#fff')}>
              ...
              <a href={`tel:${SP_TEL}`} onClick={() => go('urgencias')} className="sq tarjeta-toque" style={css('flex:1;display:flex;align-items:center;gap:13px;background:rgba(244,67,54,0.14);border:1px solid rgba(244,67,54,0.35);--sq:18px;padding:18px 20px;color:#fff')}>
