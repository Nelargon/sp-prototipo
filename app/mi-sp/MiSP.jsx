        ...
        <div style={css('max-width:860px;margin:0 auto')}>
          ...
          <div className="misp-grid" style={css('display:grid;grid-template-columns:1.4fr 1fr;gap:16px;margin-bottom:40px')}>
            ...
            <div style={css('display:flex;flex-direction:column;gap:16px')}>
              <a href={waHref} onClick={() => go('whatsapp')} target="_blank" rel="noopener" className="sq tarjeta-toque" style={css('flex:1;display:flex;align-items:center;gap:13px;background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.16);--sq:var(--r-lg);padding:18px 20px;color:#fff')}>
                <span className="sq" style={css('width:40px;height:40px;--sq:var(--r-sm);background:rgba(0,188,180,0.2);color:var(--sp-teal);display:flex;align-items:center;justify-content:center;flex:none')}><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><path d="M21 11.5a8.4 8.4 0 0 1-12.4 7.4L3 21l2.1-5.5A8.4 8.4 0 1 1 21 11.5Z" /></svg></span>
              ...
              <a href={`tel:${SP_TEL}`} onClick={() => go('urgencias')} className="sq tarjeta-toque" style={css('flex:1;display:flex;align-items:center;gap:13px;background:rgba(244,67,54,0.14);border:1px solid rgba(244,67,54,0.35);--sq:var(--r-lg);padding:18px 20px;color:#fff')}>
                <span className="sq" style={css('width:40px;height:40px;--sq:var(--r-sm);background:rgba(244,67,54,0.28);color:#ffb4ae;display:flex;align-items:center;justify-content:center;flex:none')}><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3 19.5 19.5 0 0 1-6-6 19.8 19.8 0 0 1-3-8.7A2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.1 1 .4 2 .7 2.8a2 2 0 0 1-.4 2.1L8.1 9.9a16 16 0 0 0 6 6l1.3-1.3a2 2 0 0 1 2.1-.4c.9.3 1.9.5 2.8.7a2 2 0 0 1 1.7 2Z" /></svg></span>
