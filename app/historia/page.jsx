      ...
      <section style={css('padding:90px 24px 110px;text-align:center;background:#002A52')}>
        <div style={css('max-width:640px;margin:0 auto')}>
          ...
          <div style={css('display:flex;gap:12px;flex-wrap:wrap;justify-content:center')}>
            <a href={`${BP}/simulador/`} className="btn-teal" style={css('height:52px;padding:0 28px;border-radius:14px;background:#007d77;color:#fff;font-size:16px;font-weight:700;display:inline-flex;align-items:center;gap:9px')}>Simulá tu plan <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M13 6l6 6-6 6" /></svg></a>
