          ...
          {chips.map((t) => {
            ...
            return (
              <button
                ...
                onClick={() => setActive(t)}
                aria-pressed={on}
                style={css('margin-top:20px;cursor:pointer;font-family:var(--font-display),sans-serif;font-weight:700;font-size:13.5px;padding:9px 16px;border-radius:var(--r-pill);border:1px solid ' + (on ? 'var(--sp-teal)' : 'rgba(255,255,255,0.28)') + ';background:' + (on ? 'var(--sp-teal)' : 'transparent') + ';color:' + (on ? '#012a2a' : 'rgba(255,255,255,0.88)'))}
              >
