        ...
        <div className="sl-grid" style={css('display:grid;grid-template-columns:repeat(3,1fr);gap:20px')}>
          {notas.map((n) => (
            ...
            >
              ...
              <div className="disp" style={css('font-size:16px;line-height:1.3;letter-spacing:-0.01em;color:var(--sp-navy);margin:0 0 6px')}>
                {n.title}
              </div>
              <div style={css('font-family:var(--font-inter),-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Arial,sans-serif;font-size:12.5px;color:var(--sp-muted)')}>
