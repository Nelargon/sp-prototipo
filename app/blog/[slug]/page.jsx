...
export default async function BlogPost({ params }) {
  ...
  return (
    <>
      ...
      <A title={post.title} intro={post.intro} minutes={post.minutes} date={formatFecha(post.date)} categoria={post.categoria} slug={post.slug} cover={post.cover} relacionadas={getRelacionadas(post.slug, 3)} serie={getContextoDeSerie(post.slug)}>
