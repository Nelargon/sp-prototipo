  ...
  return (
    <div className="body" style={css('min-height:100vh;background:#fff;color:var(--sp-ink)')}>
      ...
      <article style={css('max-width:680px;margin:0 auto;padding:18px 24px 40px')}>
        ...
        <div style={css('font-family:var(--font-inter),-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Arial,sans-serif;font-size:13px;color:var(--sp-muted);padding-bottom:26px;border-bottom:1px solid var(--sp-line-2);margin-bottom:30px')}>Equipo Salud Protegida · {date} · Lectura de {minutes} min</div>
        ...
        {serie && (
          <a href={`${BP}/blog/guia/${serie.slug}/`} style={css('display:flex;align-items:center;gap:10px;background:var(--sp-mint-soft);border:1px solid var(--sp-mint-line);border-radius:var(--r-sm);padding:12px 15px;margin:0 0 28px;color:var(--sp-teal-ink);font-family:var(--font-inter),-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Arial,sans-serif;font-size:13.5px')}>
      ...
      {serie && serie.siguiente && (
        <div style={css('max-width:680px;margin:0 auto;padding:34px 24px 0')}>
          <a href={`${BP}/blog/${serie.siguiente.slug}/`} style={css('display:block;border:1px solid #E3EEF7;border-radius:var(--r-md);padding:20px 22px;color:inherit;background:#F7FBFE')}>
            ...
            <div className="disp" style={css('font-size:20px;line-height:1.28;letter-spacing:-0.01em;color:var(--sp-navy);margin-bottom:6px')}>{serie.siguiente.title}</div>
            <div style={css('font-family:var(--font-inter),-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Arial,sans-serif;font-size:13px;color:var(--sp-muted)')}>Lectura de {serie.siguiente.minutes} min</div>
          </a>
        </div>
      )}
      ...
      <div style={css('max-width:680px;margin:0 auto;padding:26px 24px 70px')}>
        <div style={css('background:var(--sp-navy);border-radius:18px;padding:28px 26px;color:#fff')}>
          ...
          <a href={`${BP}/simulador/`} className="btn-teal" style={css('height:48px;padding:0 24px;border-radius:var(--r-sm);background:var(--sp-teal-deep);color:#fff;font-size:15px;font-weight:800;display:inline-flex;align-items:center;gap:8px')}>Simulá tu plan <svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M13 6l6 6-6 6" /></svg></a>
        </div>
      </div>
    </div>
  );
...
export const H2 = ({ children }) => <h2 className="disp" style={css('font-size:23px;line-height:1.25;letter-spacing:-0.01em;color:var(--sp-navy);margin:34px 0 12px')}>{children}</h2>;
export const P = ({ children }) => <p style={css('font-family:var(--font-inter),-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Arial,sans-serif;font-size:17px;line-height:1.8;color:var(--sp-text);margin:0 0 18px')}>{children}</p>;
export const B = ({ children }) => <strong style={css('color:var(--sp-ink);font-weight:700')}>{children}</strong>;
export const Callout = ({ children }) => <div style={css('font-family:var(--font-inter),-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Arial,sans-serif;background:var(--sp-mint-soft);border-left:3px solid var(--sp-teal);border-radius:0 12px 12px 0;padding:16px 18px;font-size:16px;line-height:1.7;color:var(--sp-teal-ink);margin:0 0 16px')}>{children}</div>;
export const Nota = ({ children }) => <div style={css('font-family:var(--font-inter),-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Arial,sans-serif;font-size:14px;line-height:1.65;color:var(--sp-muted);background:#F7F7F7;border-radius:var(--r-sm);padding:14px 16px;margin:26px 0 0')}>{children}</div>;
