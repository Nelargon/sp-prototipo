  ...
  return (
    <div className="body tactil" style={css('min-height:100vh;background:#fff;color:var(--sp-ink)')}>
      ...
      <article style={css('max-width:680px;margin:0 auto;padding:18px 24px 40px')}>
        ...
        {serie && (
          <a href={`${BP}/blog/guia/${serie.slug}/`} className="sq rel tarjeta-toque" style={css('display:flex;align-items:center;gap:10px;background:var(--sp-mint-soft);border:1px solid var(--sp-mint-line);--sq:var(--r-sm);padding:12px 15px;margin:0 0 28px;color:var(--sp-teal-ink);font-family:var(--font-inter),-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Arial,sans-serif;font-size:13.5px')}>
      ...
      {serie && serie.siguiente && (
        <div style={css('max-width:680px;margin:0 auto;padding:34px 24px 0')}>
          <a href={`${BP}/blog/${serie.siguiente.slug}/`} className="sq rel tarjeta-toque" style={css('display:block;border:1px solid #E3EEF7;--sq:var(--r-md);padding:20px 22px;color:inherit;background:#F7FBFE')}>
...
export const Nota = ({ children }) => <div className="sq" style={css('font-family:var(--font-inter),-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Arial,sans-serif;font-size:14px;line-height:1.65;color:var(--sp-muted);background:#F7F7F7;--sq:var(--r-sm);padding:14px 16px;margin:26px 0 0')}>{children}</div>;
