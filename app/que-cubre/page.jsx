...
export const metadata = {
  title: '¿Y esto, me lo cubre? — Essential, Silver y Gold · Salud Protegida',
  description:
    'Escribí el estudio, la cirugía o el especialista que necesitás y mirá qué hace cada plan con eso: 934 estudios y 43 especialidades de la grilla oficial de Silver y Gold, con los precios vigentes.',
