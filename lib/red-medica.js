/* La red médica real — búsqueda y filtros de la Guía Médica (sep 2026).
   ...
   Nombres: de cara al cliente nunca "Privilege" (HANDOFF dec. 11o). El plan de
   entrada se llama "Essential", como en los PDF (Arturo, 24/09/2026: el
   cliente ve "Essential"). Entre el 23 y el 24/09 se mostró como "SP Esencial".
